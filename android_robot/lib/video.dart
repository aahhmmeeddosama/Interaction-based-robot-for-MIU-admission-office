...
class _VideoScreenState extends State<VideoScreen> {
  ...
  _camera() async {
    ...
    apif("http://192.168.196.87:8003/Video_Split", selectVideo);
  }
  ...
  Widget videoPreview() {
    return Container(
        ...
        child: videoFile == null
            ? const Center(
                child: Icon(Icons.videocam, color: MyColors.myWhite, size: 50.0),
              )
            : FittedBox(
                child: mounted
                    ? Chewie(
  ...
  Widget cameraButton() {
    return RaisedButton(
        child: Row(
          ...
          children: const [Text('Camera'), Icon(Icons.video_call, color: MyColors.myRed) ],
        ),
        onPressed: () {
          _camera();
        });
