...
class ChatBot extends StatefulWidget {
  final String recoResponse;
  final String emoResponse;
  final String ageResponse;
  final String genResponse;
...
class _ChatBotState extends State<ChatBot> {
  ...
  static const String reviewUrl =
      ip + "8003/applicant_comment?name="; //ahmed&comment=no
  ...
  _onChangeHandler() {
    const duration = Duration(
        milliseconds:
            150000); // set the duration that you want call pop() after that. 1sec =1000mill
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Form(
        child: Column(
          children: [
            TextField(
              style: const TextStyle(color: MyColors.myBlack, fontSize: 30),
      ...
      actions: [
        TextButton(
          child: Text("Submit", style: TextStyle(color: MyColors.myRed)),
          onPressed: () {
      ...
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
              ...
              onPressed: () => {getQuestionResponse("Bye")}),
        ...
        body: Stack(
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(140, 660, 50, 0),
              child: reviewButton(),
            ),
          ],
        ),
