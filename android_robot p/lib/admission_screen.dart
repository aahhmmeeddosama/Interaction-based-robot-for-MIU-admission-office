...
class Admission extends StatelessWidget {
  String arabicurl='http://192.168.96.87:8005/';
  String englishurl='http://192.168.96.87:8002/';
  ...
  showAlertDialogDelete(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Choose",textAlign: TextAlign.center, style: TextStyle(fontSize: 25,fontFamily:"Times New Roman",fontWeight: FontWeight.bold,color:Colors.red[700] )),
      content: Text("which dataset you need to access 'Arabic' OR 'English' ",
        style: TextStyle(
          fontSize: 20,
          color: Colors.black,
          fontFamily: "Times New Roman",
