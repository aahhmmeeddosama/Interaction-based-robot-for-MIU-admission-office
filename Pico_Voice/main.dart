...
class _MyHomePageState extends State<MyHomePage> {
  final String accessKey =
      "sSw+4RixCh27VrboSAMWx3c0dCjzPhuEkPpZQSA4Zbt58Cfuqxh8kw=="; // AccessKey obtained from Picovoice Console (https://picovoice.ai/console/)
  ...
  void _initPicovoice() async {
    ...
    String keywordAsset = "assets/$platform/hey-pepper_en_$platform.ppn";
    String contextAsset = "assets/$platform/clock_en_$platform.rhn";
  ...
  void _inferenceCallback(RhinoInference inference) {
    ...
    if (inference.isUnderstood!) {
      ...
      if (inference.intent == 'clock') {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => Edit_Q_A()));
        _setAlarm(slots);
